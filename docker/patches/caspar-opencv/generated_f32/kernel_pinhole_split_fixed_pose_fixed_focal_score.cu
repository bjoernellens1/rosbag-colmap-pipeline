...
__global__ void __launch_bounds__(1024, 1)
    PinholeSplitFixedPoseFixedFocalScoreKernel(
        ...
        float *focal, unsigned int focal_num_alloc, float *const out_rTr,
        size_t problem_size) {
...
void PinholeSplitFixedPoseFixedFocalScore(
    float *sensor_from_rig, unsigned int sensor_from_rig_num_alloc,
    float *principal_point, unsigned int principal_point_num_alloc,
    SharedIndex *principal_point_indices, float *point,
    unsigned int point_num_alloc, SharedIndex *point_indices, float *pixel,
  ...
  PinholeSplitFixedPoseFixedFocalScoreKernel<<<n_blocks, 1024>>>(
      ...
      pose_num_alloc, focal, focal_num_alloc, out_rTr, problem_size);
}
