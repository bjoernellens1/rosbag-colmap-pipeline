...
__global__ void __launch_bounds__(1024, 1)
    SimpleRadialSplitFixedPoseFixedPrincipalPointFixedPointResJacFirstKernel(
  ...
  if (global_thread_idx < problem_size) {
    ReadShared2<float>((float *)inout_shared,
                       focal_and_extra_indices_loc[threadIdx.x].target, r0, r5);
  };
  __syncthreads();
  if (global_thread_idx < problem_size) {
  ...
  if (global_thread_idx < problem_size) {
    ...
    r43 = r43 * r2;
    r2 = r4 * r3;
    r2 = fmaf(r1, r2, r23 * r43);
    r23 = r0 * r10;
    r1 = r25 * r23;
    r20 = r4 * r28;
    r20 = r20 * r3;
    r20 = r20 * r25;
    r20 = fmaf(r23, r20, r43 * r1);
    WriteSum2<float, float>((float *)inout_shared, r2, r20);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    r2 = r5 * r5;
    r2 = r2 * r40;
    r2 = fmaf(r22, r2, r33 * r20);
    r10 = r0 * r10;
    r40 = r40 * r23;
    r10 = r10 * r40;
    r10 = fmaf(r33, r10, r22 * r10);
    WriteSum2<float, float>((float *)inout_shared, r2, r10);
  };
  ...
  if (global_thread_idx < problem_size) {
    r10 = r5 * r33;
    r2 = r5 * r22;
    r2 = fmaf(r40, r2, r40 * r10);
    WriteSum1<float, float>((float *)inout_shared, r2);
  };
...
void SimpleRadialSplitFixedPoseFixedPrincipalPointFixedPointResJacFirst(
    float *sensor_from_rig, unsigned int sensor_from_rig_num_alloc,
    float *focal_and_extra, unsigned int focal_and_extra_num_alloc,
    SharedIndex *focal_and_extra_indices, float *pixel,
    unsigned int pixel_num_alloc, float *pose, unsigned int pose_num_alloc,
