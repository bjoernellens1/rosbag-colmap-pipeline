...
__global__ void __launch_bounds__(1024, 1)
    PinholeSplitFixedPoseFixedFocalResJacKernel(
        ...
        float *focal, unsigned int focal_num_alloc, float *out_res,
        unsigned int out_res_num_alloc, float *out_principal_point_jac,
  ...
  if (global_thread_idx < problem_size) {
    WriteSum2<float, float>((float *)inout_shared, r35, r35);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    WriteIdx4<1024, float, float, float4>(out_point_jac,
                                          ...
                                          global_thread_idx, r35, r9, r10, r30);
    r34 = r7 * r46;
    r5 = fmaf(r43, r5, r0 * r34);
    r34 = r37 * r18;
    r47 = r43 * r39;
    ...
    r34 = r4 * r3;
    r29 = r4 * r2;
    r29 = fmaf(r5, r29, r47 * r34);
    WriteSum3<float, float>((float *)inout_shared, r8, r0, r29);
  };
...
void PinholeSplitFixedPoseFixedFocalResJac(
  ...
  PinholeSplitFixedPoseFixedFocalResJacKernel<<<n_blocks, 1024>>>(
