...
__global__ void __launch_bounds__(1024, 1)
    PinholeSplitFixedFocalResJacFirstKernel(
        ...
        unsigned int pixel_num_alloc, float *focal,
        unsigned int focal_num_alloc, float *out_res,
  ...
  SumStore<float>(out_rTr_local, (float *)inout_shared, 0,
                  global_thread_idx < problem_size, r33);
  if (global_thread_idx < problem_size) {
    r33 = r20 * r25;
    r32 = r13 * r18;
    ...
    WriteIdx4<1024, float, float, float4>(
        out_pose_jac, 0 * out_pose_jac_num_alloc, global_thread_idx, r67, r75,
        r70, r57);
    r79 = r21 * r64;
    r33 = r12 * r18;
    ...
    WriteIdx4<1024, float, float, float4>(out_pose_jac,
                                          ...
                                          global_thread_idx, r64, r9, r73, r10);
    r79 = r7 * r34;
    ...
    WriteIdx4<1024, float, float, float4>(out_pose_jac,
                                          ...
                                          global_thread_idx, r79, r8, r22, r29);
    r63 = r4 * r3;
    r72 = r4 * r2;
  ...
  if (global_thread_idx < problem_size) {
    ...
    WriteIdx4<1024, float, float, float4>(out_point_jac,
                                          ...
                                          global_thread_idx, r38, r29, r73, r8);
    r64 = r7 * r53;
...
void PinholeSplitFixedFocalResJacFirst(
  ...
  PinholeSplitFixedFocalResJacFirstKernel<<<n_blocks, 1024>>>(
      ...
      pixel_num_alloc, focal, focal_num_alloc, out_res, out_res_num_alloc,
