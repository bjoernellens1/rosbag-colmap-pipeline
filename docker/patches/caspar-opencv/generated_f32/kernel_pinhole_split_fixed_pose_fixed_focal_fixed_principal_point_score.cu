...
__global__ void __launch_bounds__(1024, 1)
    PinholeSplitFixedPoseFixedFocalFixedPrincipalPointScoreKernel(
...
void PinholeSplitFixedPoseFixedFocalFixedPrincipalPointScore(
    float *sensor_from_rig, unsigned int sensor_from_rig_num_alloc,
    float *point, unsigned int point_num_alloc, SharedIndex *point_indices,
    float *pixel, unsigned int pixel_num_alloc, float *pose,
    unsigned int pose_num_alloc, float *focal, unsigned int focal_num_alloc,
  ...
  PinholeSplitFixedPoseFixedFocalFixedPrincipalPointScoreKernel<<<n_blocks,
                                                                  1024>>>(
      ...
      focal_num_alloc, principal_point, principal_point_num_alloc, out_rTr,
      problem_size);
}
