...
__global__ void
__launch_bounds__(1024, 1) SimpleRadialFixedPointResJacFirstKernel(
  ...
  if (global_thread_idx < problem_size) {
    ReadShared3<float>((float *)inout_shared,
                       pose_indices_loc[threadIdx.x].target, r37, r38, r39);
  };
  __syncthreads();
  if (global_thread_idx < problem_size) {
    r40 = r16 * r18;
  ...
  if (global_thread_idx < problem_size) {
    ...
    WriteIdx4<1024, float, float, float4>(
        out_pose_jac, 0 * out_pose_jac_num_alloc, global_thread_idx, r28, r60,
        r55, r81);
    ...
    r54 = fmaf(r8, r74, r54);
    WriteIdx4<1024, float, float, float4>(
        out_pose_jac, 4 * out_pose_jac_num_alloc, global_thread_idx, r51, r26,
        r10, r54);
    r80 = r42 * r39;
    r11 = r47 * r36;
    r52 = r2 * r46;
    ...
    r74 = fmaf(r1, r62, r74);
    WriteIdx4<1024, float, float, float4>(
        out_pose_jac, 8 * out_pose_jac_num_alloc, global_thread_idx, r11, r80,
        r68, r74);
    r62 = r6 * r4;
    r1 = r6 * r5;
  ...
  if (global_thread_idx < problem_size) {
    ...
    r11 = r11 * r50;
    WriteIdx4<1024, float, float, float4>(
        out_calib_jac, 0 * out_calib_jac_num_alloc, global_thread_idx, r68, r54,
        r51, r11);
    r74 = r6 * r4;
    r80 = r6 * r5;
    r10 = r29 * r4;
