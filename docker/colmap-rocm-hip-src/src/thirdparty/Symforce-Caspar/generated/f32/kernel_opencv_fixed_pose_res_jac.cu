...
__global__ void __launch_bounds__(1024, 1) OpencvFixedPoseResJacKernel(
  ...
  if (global_thread_idx < problem_size) {
    ...
    r66 = r24 * r11;
    r66 = r66 * r26;
    r66 = fmaf(r10, r66, r42 * r39);
    r66 = r66 + r58;
    r58 = r25 * r51;
    r58 = r58 * r11;
    r58 = r58 * r38;
    r58 = fmaf(r10, r58, r0 * r66);
    r66 = r25 * r51;
    r66 = r66 * r11;
    r58 = fmaf(r10, r66, r58);
    r39 = r1 * r30;
    r39 = r39 * r24;
    r58 = fmaf(r45, r39, r58);
    r47 = r1 * r51;
    r58 = fmaf(r33, r47, r58);
    r53 = r11 * r44;
    ...
    r65 = r65 * r11;
    r65 = r65 * r32;
    r65 = fmaf(r42, r65, r10 * r6);
    r65 = r65 + r2;
    r65 = fmaf(r22, r13, r0 * r65);
    r2 = r1 * r30;
    r2 = r2 * r22;
    r65 = fmaf(r45, r2, r65);
    r6 = r25 * r28;
    ...
    r32 = r32 * r11;
    r32 = r32 * r38;
    r65 = fmaf(r10, r32, r65);
    r10 = r11 * r54;
    r65 = fmaf(r13, r10, r65);
    r65 = fmaf(r22, r9, r65);
    r65 = fmaf(r1, r33, r65);
    r65 = fmaf(r36, r55, r65);
    r55 = r5 * r65;
    WriteIdx2<1024, float, float, float2>(out_point_jac,
                                          4 * out_point_jac_num_alloc,
                                          global_thread_idx, r47, r55);
    r55 = r5 * r25;
    r55 = r55 * r3;
    r55 = fmaf(r56, r63, r61 * r55);
    r47 = r5 * r25;
    r47 = r47 * r3;
    r47 = fmaf(r48, r63, r58 * r47);
    r10 = r5 * r25;
    r10 = r10 * r3;
    r63 = fmaf(r53, r63, r65 * r10);
    WriteSum3<float, float>((float *)inout_shared, r55, r47, r63);
  };
  ...
  if (global_thread_idx < problem_size) {
    r63 = r56 * r56;
    r47 = r61 * r61;
    r47 = fmaf(r62, r47, r60 * r63);
    r63 = r48 * r48;
    r55 = r58 * r58;
    r55 = fmaf(r62, r55, r60 * r63);
    r63 = r53 * r53;
    r10 = r65 * r65;
    r10 = fmaf(r62, r10, r60 * r63);
    WriteSum3<float, float>((float *)inout_shared, r47, r55, r10);
  };
  ...
  if (global_thread_idx < problem_size) {
    r10 = r61 * r58;
    r55 = r56 * r48;
    r55 = fmaf(r60, r55, r62 * r10);
    r10 = r56 * r53;
    r47 = r61 * r65;
    r47 = fmaf(r62, r47, r60 * r10);
    r10 = r48 * r53;
    r63 = r58 * r65;
    r63 = fmaf(r62, r63, r60 * r10);
    WriteSum3<float, float>((float *)inout_shared, r55, r47, r63);
  };
