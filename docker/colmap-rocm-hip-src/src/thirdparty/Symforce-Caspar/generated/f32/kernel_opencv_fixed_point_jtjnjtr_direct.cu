...
__global__ void __launch_bounds__(1024, 1) OpencvFixedPointJtjnjtrDirectKernel(
    ...
    float *calib_jac, unsigned int calib_jac_num_alloc,
  ...
  if (global_thread_idx < problem_size) {
    ...
    r5 = fmaf(r16, r21, r5);
    r5 = fmaf(r15, r19, r5);
    r15 = fmaf(r1, r5, r0 * r6);
    r16 = fmaf(r3, r5, r2 * r6);
    ReadIdx4<1024, float, float, float4>(pose_jac, 4 * pose_jac_num_alloc,
                                         global_thread_idx, r17, r4, r7, r14);
    r22 = fmaf(r4, r5, r17 * r6);
    r23 = fmaf(r14, r5, r7 * r6);
    WriteSum4<float, float>((float *)inout_shared, r15, r16, r22, r23);
  };
  ...
  if (global_thread_idx < problem_size) {
    ReadIdx4<1024, float, float, float4>(pose_jac, 8 * pose_jac_num_alloc,
                                         global_thread_idx, r23, r22, r16, r15);
    r24 = fmaf(r22, r5, r23 * r6);
    r6 = fmaf(r16, r6, r15 * r5);
  ...
  __syncthreads();
  if (global_thread_idx < problem_size) {
    r23 = fmaf(r6, r23, r24 * r16);
  };
  LoadShared<4, float, float>(pose_njtr, 0 * pose_njtr_num_alloc,
                              pose_njtr_indices_loc, (float *)inout_shared);
  if (global_thread_idx < problem_size) {
    ReadShared4<float>((float *)inout_shared,
                       pose_njtr_indices_loc[threadIdx.x].target, r16, r5, r25,
                       r26);
  };
  __syncthreads();
  if (global_thread_idx < problem_size) {
    r23 = fmaf(r25, r17, r23);
    r23 = fmaf(r26, r7, r23);
    r23 = fmaf(r16, r0, r23);
    r23 = fmaf(r5, r2, r23);
    r18 = r18 * r23;
    r14 = fmaf(r26, r14, r24 * r15);
    r14 = fmaf(r25, r4, r14);
    r14 = fmaf(r16, r1, r14);
    r14 = fmaf(r5, r3, r14);
    r14 = fmaf(r6, r22, r14);
    r19 = r19 * r14;
    r21 = fmaf(r21, r14, r20 * r23);
    r11 = fmaf(r11, r14, r10 * r23);
    WriteSum4<float, float>((float *)inout_shared, r18, r19, r21, r11);
  };
  FlushSumShared<4, float>(out_calib_njtr, 0 * out_calib_njtr_num_alloc,
                           calib_njtr_indices_loc, (float *)inout_shared);
  if (global_thread_idx < problem_size) {
    r13 = fmaf(r13, r14, r12 * r23);
    r8 = fmaf(r8, r23, r9 * r14);
    WriteSum4<float, float>((float *)inout_shared, r13, r8, r23, r14);
  };
  FlushSumShared<4, float>(out_calib_njtr, 4 * out_calib_njtr_num_alloc,
                           calib_njtr_indices_loc, (float *)inout_shared);
}

void OpencvFixedPointJtjnjtrDirect(
    float *pose_njtr, unsigned int pose_njtr_num_alloc,
    SharedIndex *pose_njtr_indices, float *pose_jac,
    unsigned int pose_jac_num_alloc, float *calib_njtr,
    unsigned int calib_njtr_num_alloc, SharedIndex *calib_njtr_indices,
  ...
  OpencvFixedPointJtjnjtrDirectKernel<<<n_blocks, 1024>>>(
      ...
      calib_jac, calib_jac_num_alloc, out_pose_njtr, out_pose_njtr_num_alloc,
      out_calib_njtr, out_calib_njtr_num_alloc, problem_size);
}
