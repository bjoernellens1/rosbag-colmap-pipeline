...
__global__ void __launch_bounds__(1024, 1)
    OpencvSplitFixedFocalAndExtraFixedPrincipalPointScoreKernel(
  ...
  if (global_thread_idx < problem_size) {
    ReadShared4<float>((float *)inout_shared,
                       pose_indices_loc[threadIdx.x].target, r16, r17, r18,
                       r19);
  };
  __syncthreads();
  if (global_thread_idx < problem_size) {
    ...
    r28 = fmaf(r17, r20, r18 * r23);
    r29 = r16 * r21;
    r28 = fmaf(r25, r29, r28);
    r28 = fmaf(r19, r22, r28);
    r29 = 2.00000000000000000e+00;
    r19 = fmaf(r19, r20, r16 * r23);
    r30 = r17 * r22;
    r19 = fmaf(r25, r30, r19);
    r19 = fmaf(r18, r21, r19);
    r30 = r29 * r19;
    r31 = r28 * r30;
  ...
  if (global_thread_idx < problem_size) {
    ReadShared3<float>((float *)inout_shared,
                       pose_indices_loc[threadIdx.x].target, r11, r32, r33);
  };
  __syncthreads();
  if (global_thread_idx < problem_size) {
    r34 = r20 * r22;
...
void OpencvSplitFixedFocalAndExtraFixedPrincipalPointScore(
    float *pose, unsigned int pose_num_alloc, SharedIndex *pose_indices,
    float *sensor_from_rig, unsigned int sensor_from_rig_num_alloc,
    float *point, unsigned int point_num_alloc, SharedIndex *point_indices,
    float *pixel, unsigned int pixel_num_alloc, float *focal_and_extra,
  ...
  OpencvSplitFixedFocalAndExtraFixedPrincipalPointScoreKernel<<<n_blocks,
                                                                1024>>>(
      ...
      principal_point, principal_point_num_alloc, out_rTr, problem_size);
}
