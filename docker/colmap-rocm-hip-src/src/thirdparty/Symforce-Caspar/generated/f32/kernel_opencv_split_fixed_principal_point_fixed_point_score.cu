...
__global__ void __launch_bounds__(1024, 1)
    OpencvSplitFixedPrincipalPointFixedPointScoreKernel(
...
void OpencvSplitFixedPrincipalPointFixedPointScore(
    float *pose, unsigned int pose_num_alloc, SharedIndex *pose_indices,
    float *sensor_from_rig, unsigned int sensor_from_rig_num_alloc,
    float *focal_and_extra, unsigned int focal_and_extra_num_alloc,
    SharedIndex *focal_and_extra_indices, float *pixel,
  ...
  OpencvSplitFixedPrincipalPointFixedPointScoreKernel<<<n_blocks, 1024>>>(
      ...
      principal_point_num_alloc, point, point_num_alloc, out_rTr, problem_size);
}
