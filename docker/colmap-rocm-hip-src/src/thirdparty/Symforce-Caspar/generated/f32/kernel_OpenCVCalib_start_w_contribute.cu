...
__global__ void __launch_bounds__(1024, 1) OpenCVCalibStartWContributeKernel(
  ...
  if (global_thread_idx < problem_size) {
    ...
    r3 = r3 * r4;
    r3 = r3 * r8;
    AddIdx4<1024, float, float, float4>(out_OpenCVCalib_w,
...
void OpenCVCalibStartWContribute(
  ...
  OpenCVCalibStartWContributeKernel<<<n_blocks, 1024>>>(
