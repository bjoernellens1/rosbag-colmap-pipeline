...
__global__ void __launch_bounds__(1024, 1) OpenCVCalibUpdateStepFirstKernel(
...
void OpenCVCalibUpdateStepFirst(float *OpenCVCalib_p_kp1,
  ...
  OpenCVCalibUpdateStepFirstKernel<<<n_blocks, 1024>>>(
      OpenCVCalib_p_kp1, OpenCVCalib_p_kp1_num_alloc, alpha,
      out_OpenCVCalib_step_kp1, out_OpenCVCalib_step_kp1_num_alloc,
      problem_size);
}
