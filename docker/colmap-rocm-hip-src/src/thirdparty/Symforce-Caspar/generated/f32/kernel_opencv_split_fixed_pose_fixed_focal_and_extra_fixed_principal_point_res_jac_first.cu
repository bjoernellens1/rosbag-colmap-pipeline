...
__global__ void __launch_bounds__(1024, 1)
  ...
  if (global_thread_idx < problem_size) {
    ...
    r53 = r2 * r2;
    r50 = r32 * r32;
    r50 = fmaf(r53, r50, r0 * r58);
    r58 = r51 * r51;
    r22 = r56 * r56;
    r22 = fmaf(r0, r22, r53 * r58);
    r58 = r12 * r53;
    r10 = r44 * r0;
    r44 = fmaf(r44, r10, r12 * r58);
    WriteSum3<float, float>((float *)inout_shared, r50, r22, r44);
  };
  ...
  if (global_thread_idx < problem_size) {
    r44 = r49 * r56;
    r22 = r32 * r51;
    r22 = fmaf(r53, r22, r0 * r44);
    r44 = fmaf(r32, r58, r49 * r10);
    r10 = fmaf(r56, r10, r51 * r58);
    WriteSum3<float, float>((float *)inout_shared, r22, r44, r10);
  };
