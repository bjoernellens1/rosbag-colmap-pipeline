...
__global__ void __launch_bounds__(1024, 1)
    OpencvSplitFixedPrincipalPointJtjnjtrDirectKernel(
  ...
  if (global_thread_idx < problem_size) {
    ReadShared3<float>((float *)inout_shared,
                       point_njtr_indices_loc[threadIdx.x].target, r4, r21,
                       r22);
  };
  __syncthreads();
  if (global_thread_idx < problem_size) {
    ReadIdx2<1024, float, float, float2>(point_jac, 4 * point_jac_num_alloc,
                                         global_thread_idx, r23, r24);
    ReadIdx4<1024, float, float, float4>(point_jac, 0 * point_jac_num_alloc,
                                         global_thread_idx, r25, r26, r27, r28);
    r29 = fmaf(r21, r27, r22 * r23);
    r29 = fmaf(r4, r25, r29);
    r30 = r14 + r29;
    ...
    r6 = fmaf(r5, r16, r6);
    r6 = fmaf(r13, r20, r6);
    r21 = fmaf(r21, r28, r22 * r24);
    r21 = fmaf(r4, r26, r21);
    r4 = r6 + r21;
    r22 = fmaf(r1, r4, r0 * r30);
    r13 = fmaf(r3, r4, r2 * r30);
    ReadIdx4<1024, float, float, float4>(pose_jac, 4 * pose_jac_num_alloc,
                                         global_thread_idx, r5, r12, r7, r31);
    r32 = fmaf(r12, r4, r5 * r30);
    r33 = fmaf(r31, r4, r7 * r30);
    WriteSum4<float, float>((float *)inout_shared, r22, r13, r32, r33);
  };
  ...
  if (global_thread_idx < problem_size) {
    ReadIdx4<1024, float, float, float4>(pose_jac, 8 * pose_jac_num_alloc,
                                         global_thread_idx, r33, r32, r13, r22);
    r34 = fmaf(r32, r4, r33 * r30);
    r30 = fmaf(r13, r30, r22 * r4);
    WriteSum2<float, float>((float *)inout_shared, r34, r30);
  };
  ...
  if (global_thread_idx < problem_size) {
    ReadShared2<float>((float *)inout_shared,
                       pose_njtr_indices_loc[threadIdx.x].target, r30, r34);
  };
  __syncthreads();
  if (global_thread_idx < problem_size) {
    r33 = fmaf(r30, r33, r34 * r13);
  };
  LoadShared<4, float, float>(pose_njtr, 0 * pose_njtr_num_alloc,
                              pose_njtr_indices_loc, (float *)inout_shared);
  if (global_thread_idx < problem_size) {
    ReadShared4<float>((float *)inout_shared,
                       pose_njtr_indices_loc[threadIdx.x].target, r13, r4, r35,
                       r36);
  };
  __syncthreads();
  if (global_thread_idx < problem_size) {
    ...
    r29 = r33 + r29;
    r15 = r15 * r29;
    r31 = fmaf(r36, r31, r34 * r22);
    r31 = fmaf(r35, r12, r31);
    r31 = fmaf(r13, r1, r31);
    r31 = fmaf(r4, r3, r31);
    r31 = fmaf(r30, r32, r31);
    r21 = r31 + r21;
    r16 = r16 * r21;
    r18 = fmaf(r18, r21, r17 * r29);
    r9 = fmaf(r9, r21, r8 * r29);
  ...
  FlushSumShared<4, float>(
      ...
      focal_and_extra_njtr_indices_loc, (float *)inout_shared);
  if (global_thread_idx < problem_size) {
    r11 = fmaf(r11, r21, r10 * r29);
    r21 = fmaf(r20, r21, r19 * r29);
  ...
  if (global_thread_idx < problem_size) {
    r14 = r33 + r14;
    r6 = r31 + r6;
    r26 = fmaf(r26, r6, r25 * r14);
    r28 = fmaf(r28, r6, r27 * r14);
    r6 = fmaf(r24, r6, r23 * r14);
    WriteSum3<float, float>((float *)inout_shared, r26, r28, r6);
  };
  FlushSumShared<3, float>(out_point_njtr, 0 * out_point_njtr_num_alloc,
                           point_njtr_indices_loc, (float *)inout_shared);
}

void OpencvSplitFixedPrincipalPointJtjnjtrDirect(
    float *pose_njtr, unsigned int pose_njtr_num_alloc,
    SharedIndex *pose_njtr_indices, float *pose_jac,
    unsigned int pose_jac_num_alloc, float *focal_and_extra_njtr,
    unsigned int focal_and_extra_njtr_num_alloc,
  ...
  OpencvSplitFixedPrincipalPointJtjnjtrDirectKernel<<<n_blocks, 1024>>>(
      ...
      out_pose_njtr_num_alloc, out_focal_and_extra_njtr,
      out_focal_and_extra_njtr_num_alloc, out_point_njtr,
      out_point_njtr_num_alloc, problem_size);
}
