...
__global__ void __launch_bounds__(1024, 1) OpenCVFocalAndExtraUpdateRKernel(
  ...
  if (global_thread_idx < problem_size) {
    ...
    WriteIdx2<1024, float, float, float2>(
        out_OpenCVFocalAndExtra_r_kp1,
        4 * out_OpenCVFocalAndExtra_r_kp1_num_alloc, global_thread_idx, r1, r8);
    r1 = fmaf(r1, r1, r8 * r8);
    r1 = fmaf(r4, r4, r1);
    r1 = fmaf(r5, r5, r1);
    r1 = fmaf(r7, r7, r1);
...
void OpenCVFocalAndExtraUpdateR(
    float *OpenCVFocalAndExtra_r_k,
    unsigned int OpenCVFocalAndExtra_r_k_num_alloc,
    float *OpenCVFocalAndExtra_w, unsigned int OpenCVFocalAndExtra_w_num_alloc,
    const float *const negalpha, float *out_OpenCVFocalAndExtra_r_kp1,
  ...
  OpenCVFocalAndExtraUpdateRKernel<<<n_blocks, 1024>>>(
