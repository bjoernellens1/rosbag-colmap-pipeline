...
__global__ void __launch_bounds__(1024, 1) OpenCVCalibUpdateStepKernel(
  ...
  if (global_thread_idx < problem_size) {
    ReadIdx4<1024, float, float, float4>(OpenCVCalib_step_k,
                                         0 * OpenCVCalib_step_k_num_alloc,
  ...
  if (global_thread_idx < problem_size) {
    ...
    WriteIdx4<1024, float, float, float4>(
        out_OpenCVCalib_step_kp1, 0 * out_OpenCVCalib_step_kp1_num_alloc,
        global_thread_idx, r4, r5, r6, r7);
    ReadIdx4<1024, float, float, float4>(OpenCVCalib_step_k,
                                         4 * OpenCVCalib_step_k_num_alloc,
    ...
    r8 = fmaf(r0, r8, r4);
    WriteIdx4<1024, float, float, float4>(
        out_OpenCVCalib_step_kp1, 4 * out_OpenCVCalib_step_kp1_num_alloc,
...
void OpenCVCalibUpdateStep(
  ...
  OpenCVCalibUpdateStepKernel<<<n_blocks, 1024>>>(
      OpenCVCalib_step_k, OpenCVCalib_step_k_num_alloc, OpenCVCalib_p_kp1,
      OpenCVCalib_p_kp1_num_alloc, alpha, out_OpenCVCalib_step_kp1,
      out_OpenCVCalib_step_kp1_num_alloc, problem_size);
}
