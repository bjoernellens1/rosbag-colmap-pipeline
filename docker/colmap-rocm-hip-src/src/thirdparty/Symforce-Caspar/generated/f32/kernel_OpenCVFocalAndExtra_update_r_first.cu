...
__global__ void
__launch_bounds__(1024, 1) OpenCVFocalAndExtraUpdateRFirstKernel(
  ...
  __shared__ float out_OpenCVFocalAndExtra_r_0_norm2_tot_local[1];

  __shared__ float out_OpenCVFocalAndExtra_r_kp1_norm2_tot_local[1];
  ...
  if (global_thread_idx < problem_size) {
    ...
    WriteIdx4<1024, float, float, float4>(
        out_OpenCVFocalAndExtra_r_kp1,
        0 * out_OpenCVFocalAndExtra_r_kp1_num_alloc, global_thread_idx, r4, r5,
        r6, r7);
    ...
    WriteIdx2<1024, float, float, float2>(
        out_OpenCVFocalAndExtra_r_kp1,
        4 * out_OpenCVFocalAndExtra_r_kp1_num_alloc, global_thread_idx, r11,
        r8);
    r2 = fmaf(r2, r2, r0 * r0);
    r2 = fmaf(r3, r3, r2);
    r2 = fmaf(r9, r9, r2);
  ...
  SumStore<float>(out_OpenCVFocalAndExtra_r_0_norm2_tot_local,
                  (float *)inout_shared, 0, global_thread_idx < problem_size,
                  r2);
  if (global_thread_idx < problem_size) {
    r11 = fmaf(r11, r11, r8 * r8);
    r11 = fmaf(r4, r4, r11);
    r11 = fmaf(r5, r5, r11);
    r11 = fmaf(r7, r7, r11);
    r11 = fmaf(r6, r6, r11);
  };
  SumStore<float>(out_OpenCVFocalAndExtra_r_kp1_norm2_tot_local,
                  (float *)inout_shared, 0, global_thread_idx < problem_size,
                  r11);
  SumFlushFinal<float>(out_OpenCVFocalAndExtra_r_0_norm2_tot_local,
                       out_OpenCVFocalAndExtra_r_0_norm2_tot, 1);
  SumFlushFinal<float>(out_OpenCVFocalAndExtra_r_kp1_norm2_tot_local,
                       out_OpenCVFocalAndExtra_r_kp1_norm2_tot, 1);
}
...
void OpenCVFocalAndExtraUpdateRFirst(
  ...
  OpenCVFocalAndExtraUpdateRFirstKernel<<<n_blocks, 1024>>>(
      OpenCVFocalAndExtra_r_k, OpenCVFocalAndExtra_r_k_num_alloc,
      OpenCVFocalAndExtra_w, OpenCVFocalAndExtra_w_num_alloc, negalpha,
      out_OpenCVFocalAndExtra_r_kp1, out_OpenCVFocalAndExtra_r_kp1_num_alloc,
      out_OpenCVFocalAndExtra_r_0_norm2_tot,
      out_OpenCVFocalAndExtra_r_kp1_norm2_tot, problem_size);
}
