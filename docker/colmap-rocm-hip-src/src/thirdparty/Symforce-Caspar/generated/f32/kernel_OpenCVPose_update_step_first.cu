...
__global__ void __launch_bounds__(1024, 1) OpenCVPoseUpdateStepFirstKernel(
...
void OpenCVPoseUpdateStepFirst(float *OpenCVPose_p_kp1,
  ...
  OpenCVPoseUpdateStepFirstKernel<<<n_blocks, 1024>>>(
      OpenCVPose_p_kp1, OpenCVPose_p_kp1_num_alloc, alpha,
      out_OpenCVPose_step_kp1, out_OpenCVPose_step_kp1_num_alloc, problem_size);
}
