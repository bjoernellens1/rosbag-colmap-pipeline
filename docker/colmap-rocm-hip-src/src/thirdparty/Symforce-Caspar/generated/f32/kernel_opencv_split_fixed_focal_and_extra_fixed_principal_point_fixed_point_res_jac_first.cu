...
__global__ void __launch_bounds__(1024, 1)
    OpencvSplitFixedFocalAndExtraFixedPrincipalPointFixedPointResJacFirstKernel(
  ...
  if (global_thread_idx < problem_size) {
    ...
    r84 = r83 * r83;
    r34 = r66 * r11;
    r66 = fmaf(r66, r34, r2 * r84);
    r84 = r28 * r28;
    r0 = r49 * r2;
    r49 = fmaf(r49, r0, r11 * r84);
    r84 = r39 * r39;
    r35 = r13 * r13;
    r35 = fmaf(r11, r35, r2 * r84);
    WriteSum4<float, float>((float *)inout_shared, r26, r66, r49, r35);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    r35 = r59 * r59;
    r66 = r33 * r33;
    r66 = fmaf(r2, r66, r11 * r35);
    WriteSum2<float, float>((float *)inout_shared, r49, r66);
  };
  ...
  if (global_thread_idx < problem_size) {
    r66 = r70 * r83;
    r66 = fmaf(r2, r66, r69 * r34);
    r49 = r69 * r28;
    r49 = fmaf(r11, r49, r70 * r0);
    r35 = r70 * r39;
    r26 = r69 * r13;
    r26 = fmaf(r11, r26, r2 * r35);
    r35 = r69 * r88;
    r84 = r70 * r73;
    r84 = fmaf(r2, r84, r11 * r35);
    WriteSum4<float, float>((float *)inout_shared, r66, r49, r26, r84);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    r26 = r70 * r33;
    r26 = fmaf(r2, r26, r11 * r84);
    r84 = fmaf(r28, r34, r83 * r0);
    r49 = r83 * r39;
    r49 = fmaf(r2, r49, r13 * r34);
    r66 = r83 * r73;
    r66 = fmaf(r2, r66, r88 * r34);
    WriteSum4<float, float>((float *)inout_shared, r26, r84, r49, r66);
  };
  FlushSumShared<4, float>(out_pose_precond_tril,
  ...
  if (global_thread_idx < problem_size) {
    r66 = r83 * r33;
    r34 = fmaf(r59, r34, r2 * r66);
    r66 = r28 * r13;
    r66 = fmaf(r11, r66, r39 * r0);
    r49 = r28 * r88;
    r49 = fmaf(r11, r49, r73 * r0);
    r84 = r28 * r59;
    r84 = fmaf(r11, r84, r33 * r0);
    WriteSum4<float, float>((float *)inout_shared, r34, r66, r49, r84);
  };
  FlushSumShared<4, float>(out_pose_precond_tril,
  ...
  if (global_thread_idx < problem_size) {
    r84 = r13 * r88;
    r49 = r39 * r73;
    r49 = fmaf(r2, r49, r11 * r84);
    r84 = r13 * r59;
    r66 = r39 * r33;
    r66 = fmaf(r2, r66, r11 * r84);
    r84 = r73 * r33;
    r34 = r88 * r59;
    r34 = fmaf(r11, r34, r2 * r84);
    WriteSum3<float, float>((float *)inout_shared, r49, r66, r34);
  };
...
void OpencvSplitFixedFocalAndExtraFixedPrincipalPointFixedPointResJacFirst(
    float *pose, unsigned int pose_num_alloc, SharedIndex *pose_indices,
    float *sensor_from_rig, unsigned int sensor_from_rig_num_alloc,
    float *pixel, unsigned int pixel_num_alloc, float *focal_and_extra,
    unsigned int focal_and_extra_num_alloc, float *principal_point,
